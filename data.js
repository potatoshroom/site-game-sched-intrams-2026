...
const SCHEDULE_DATA = {
  days: [
    {
      day: 18, name: "Wednesday", date: "March 18, 2026",
      sections: [
        {
          sport: "basketball", icon: "ico-basketball",
          label: "Basketball — Men (5v5)", venue: "Leisure Coast Gym",
          matches: [
            { time: "2:30 PM", opp: "CISTE", result: "lose" }
          ]
        },
        {
          sport: "volleyball", icon: "ico-volleyball",
          label: "Volleyball — Men", venue: "Leisure Coast Court 1",
          matches: [
        ...
        {
          sport: "volleyball", icon: "ico-volleyball",
          label: "Volleyball — Women", venue: "Leisure Coast Court 2",
          matches: [
            { time: "2nd Game PM", tbd: true, opp: "CISTE", result: "win" }
          ]
        },
        {
          sport: "beach", icon: "ico-beach",
          label: "Beach Volleyball — Men", venue: "Sand Area",
          matches: [
    ...
    {
      day: 19, name: "Thursday", date: "March 19, 2026",
      sections: [
        {
          sport: "basketball", icon: "ico-basketball",
          label: "Basketball — Men (5v5)", venue: "UDD Quadrangle",
          matches: [
        ...
        {
          sport: "basketball", icon: "ico-basketball",
          label: "Basketball — Women (3v3)", venue: "LCR Gym Court #1",
          matches: [
        ...
        {
          sport: "beach", icon: "ico-beach",
          label: "Beach Volleyball — Women", venue: "Sand Area",
          matches: [
        ...
        {
          sport: "chess", icon: "ico-chess",
          label: "Chess — Men (Individual)", venue: "Library · VPA Building",
          matches: [
        ...
        {
          sport: "chess", icon: "ico-chess",
          label: "Chess — Women (Individual)", venue: "Library · VPA Building",
          matches: [
            { time: "8:30 AM",  opp: "CISTE", result: "win" },
    ...
    {
      day: 23, name: "Monday", date: "March 23, 2026",
      sections: [
        {
          sport: "basketball", icon: "ico-basketball",
          label: "Basketball — Men (5v5)", venue: "UDD Quadrangle",
        ...
        {
          sport: "scrabble", icon: "ico-scrabble",
          label: "Scrabble — Men (Singles)", venue: "Library",
          matches: [
        ...
        {
          sport: "scrabble", icon: "ico-scrabble",
          label: "Scrabble — Women (Singles)", venue: "Library",
          matches: [
            { time: "8:30 AM",  opp: "CISTE" },
            { time: "9:55 AM",  opp: "SOHE" },
        ...
        {
          sport: "scrabble", icon: "ico-scrabble",
          label: "Scrabble — Doubles", venue: "Library",
          matches: [
    ...
    {
      day: 24, name: "Tuesday", date: "March 24, 2026",
      sections: [
        {
          sport: "scrabble", icon: "ico-scrabble",
          label: "Scrabble — Doubles", venue: "Library",
        ...
        {
          sport: "tabletennis", icon: "ico-tabletennis",
          label: "Table Tennis — Men, Women & Mixed", venue: "Nikki's Garden",
          matches: [
            { time: "8:30 AM",  opp: "CISTE" },
    ...
    {
      day: 25, name: "Wednesday", date: "March 25, 2026",
      sections: [
        {
          sport: "badminton", icon: "ico-badminton",
          label: "Badminton — Men, Women & Mixed", venue: "Nikki's Garden / LCR Gym",
          highlight: true,
          matches: [
            { time: "8:30 AM",  opp: "CISTE" },
            { time: "10:30 AM", opp: "SOHE" },
